...
*Примечание:* Если сопротивление указано верно, но мощность на экране отображается  некорректно, то вы можете подобрать корректное значение, через подбор значения сопротивления
